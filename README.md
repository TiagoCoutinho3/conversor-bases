...
- **Validação de Erro:** O usuário é avisado se digitar um caractere que não pertence à base selecionada (ex: digitar '2' em binário).
- **Conversão fracionária:** Suporte a conversão de números com parte fracionaária.
